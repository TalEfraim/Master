...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.TargetImagesLabel.setGeometry(QtCore.QRect(540, 15, 251, 31))
        font = QtGui.QFont()
        ...
        self.MainVideo_2 = QtWidgets.QLabel(self.centralwidget)
        self.MainVideo_2.setGeometry(QtCore.QRect(540, 50, 241, 221))
        self.MainVideo_2.setStyleSheet("background-color: rgb(225,220,220);")
        self.MainVideo_2.setText("")
        self.MainVideo_2.setObjectName("MainVideo_2")
        ...
        self.menuMenu.addAction(self.actionPolicy)
