...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.TargetImagesLabel.setGeometry(QtCore.QRect(670, 15, 231, 31))
        font = QtGui.QFont()
        ...
        self.CurrentImage_slider.setGeometry(QtCore.QRect(630, 340, 241, 21))
        ...
        self.CurrentImage_radiobox.setGeometry(QtCore.QRect(880, 340, 42, 22))
        ...
        self.CreateReportButton.setGeometry(QtCore.QRect(680, 550, 221, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.ExportPathLabel.setGeometry(QtCore.QRect(160, 510, 741, 31))
        ...
        self.DatasetImages.setGeometry(QtCore.QRect(630, 50, 291, 281))
        ...
        self.CameraOffBtn.setStyleSheet("background-color: rgb(140 ,0 ,0)")
        self.CameraOffBtn.setObjectName("CameraOffBtn")
        self.confidenceLabel = QtWidgets.QLabel(self.centralwidget)
        self.confidenceLabel.setGeometry(QtCore.QRect(440, 60, 181, 41))
        self.confidenceLabel.setText("")
        self.confidenceLabel.setPixmap(QtGui.QPixmap("Confidence logo.png"))
